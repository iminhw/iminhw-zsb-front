package com.minhw.common.manager.factory;

import com.minhw.common.utils.LogUtils;
import com.minhw.common.utils.ServletUtils;
import com.minhw.common.utils.ip.AddressUtils;
import com.minhw.common.utils.ip.IpUtils;
import com.minhw.common.utils.spring.SpringUtils;
//import com.minhw.domain.SysLogininfor;
//import com.minhw.system.service.ISysLogininforService;
...
//                SpringUtils.getBean(ISysLogininforService.class).insertLogininfor(logininfor);
     ...
     * 操作日志记录
     *
     * @param sysHomepageVisitLog 访问日志信息
     * @return 任务task
     */
    public static TimerTask recordOper(final SysHomepageVisitLog sysHomepageVisitLog) {
        return new TimerTask() {
            @Override
            public void run() {
                // 远程查询操作地点
